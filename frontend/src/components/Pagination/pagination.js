        ...
        <div className={'container'}>
            <div className={'row'}>
                ...
                <div className={'col-md-4 cont1'}>
                    ...
                    <FontAwesomeIcon className={'arrows m-2'} onClick={() => {if (currentPage > 1) { paginate(currentPage-1) }}} icon={faChevronCircleLeft}/>
                    <FontAwesomeIcon className={'arrows m-2'} onClick={() => {if (currentPage < pageNumbers.length) {paginate(currentPage+1)}}} icon={faChevronCircleRight}/>
